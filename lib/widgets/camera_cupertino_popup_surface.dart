...
class CameraCupertinoPopupSurface extends StatelessWidget {
  final VoidCallback onDismissed; // Add the onDismissed callback

  const CameraCupertinoPopupSurface({Key? key, required this.onDismissed})
      : super(key: key);
                        ...
                        child: Align(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              ...
                              // ref.read(showPopupController.notifier).state =
                              //     true;
